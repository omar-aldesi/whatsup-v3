...
class EmailService
{
     ...
     * @return void
     */
    public function processEmail(Request $request, array &$allEmail, $userId = null): void {
        ...
        if($request->has('email')) {
            ...
            $emailArray = $email->pluck('email','id')->toArray();
            $allEmail[] = array_values($emailArray) + array_diff($request->input('email') , $emailArray);
        }
    }
