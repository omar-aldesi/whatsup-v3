    ...
    <section>
        <div class="card mb-4">
            <div class="card-header">
                <h4 class="card-title">{{translate('Email Credit Logs')}}</h4>
            </div>
                    ...
                    <div class="filter-form">
                        ...
                        <div class="filter-action">
                            ...
                            <button class="i-btn danger--btn btn--md">
                                <a class="text-white" href="{{ route('admin.report.email.credit.index') }}">
            ...
            <div class="card-body px-0">
                ...
                <div class="m-3">
                    {{$emailCreditLogs->appends(request()->all())->onEachSide(1)->links()}}
                </div>
	        </div>
	    </div>
    </section>
