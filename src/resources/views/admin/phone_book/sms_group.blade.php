                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ translate('User contact list')}}</h4>
                        </div>
                                        ...
                                        <tr class="@if($loop->even)@endif">
                                            <td data-label=" {{ translate('Name')}}">
                                             ...
                                             <td data-label=" {{ translate('Contact')}}">
                                                <a href="{{route('admin.group.sms.groupby', $group->id)}}" class="badge badge--primary p-2"> {{ translate('view contact')}}</a>
                                            </td>
