                        ...
                        <div class="card-body">
                            <div class="row pb-3 g-3">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <a href="javascript:void(0)" class="i-btn success--btn btn--md w-100 border-0 rounded text-white p-2" id="keygen"><i class="me-1 las la-key fs-5"></i> {{translate('Generate API Key')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
